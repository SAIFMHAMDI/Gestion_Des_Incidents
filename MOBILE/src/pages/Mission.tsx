  ...
  */
  ...
  useEffect(() => {
    (async () => {
      ...
      axios.get(`${API_LINK}/getMission/${user_obj.code_postal}/${user_obj.id}`).then((response) => {
  ...
  const openCapacitorSite = async (fileurl:any) => {
                      ...
                      <IonContent>
                        <IonCardContent style={{ padding: '0px', marginTop: '20px' }} className="incident-container-content-first">
                          ...
                          <IonItem lines="none">
                            ...
                            <IonLabel style={{}} onClick={(e)=>{
                              openCapacitorSite(`${API_LINK}/uploads/${selectedNotification.fiche_technique}`);
                            }}><a target="_blank" href="#" onClick={(e)=>{
                              e.preventDefault();
                            }}>Piéce jointe</a></IonLabel>
                          </IonItem>
                        </IonCardContent>
                        <IonGrid>
                          <IonRow>
